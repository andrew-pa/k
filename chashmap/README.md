This source code originally came from https://gitlab.redox-os.org/redox-os/chashmap/. I ported it to the no-std environment, exposing the `RwLock` dependency using `lock-api`.
