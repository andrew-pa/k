...
impl<'t, O, T: ?Sized> OwningRef<'t, O, T> {
    ...
    /// }
    /// ```
    /// WARN: This function is known to be unsafe
    ...
    // WARN: this is known to be unsafe
...
unsafe impl<O, T: ?Sized> StableAddress for OwningRef<'_, O, T> {}

unsafe impl<O, T: ?Sized> StableAddress for OwningRefMut<'_, O, T> {}
...
impl<O, T: ?Sized> AsMut<T> for OwningRefMut<'_, O, T> {
...
pub type BoxRefMut<'a, T, U = T> = OwningRefMut<'a, Box<T>, U>;
/// Typedef of a mutable owning reference that uses a `Vec` as the owner.
pub type VecRefMut<'a, T, U = T> = OwningRefMut<'a, Vec<T>, U>;
/// Typedef of a mutable owning reference that uses a `String` as the owner.
pub type StringRefMut<'a> = OwningRefMut<'a, String, str>;
...
pub type ErasedBoxRef<'a, U> = OwningRef<'a, Box<dyn Erased>, U>;
/// Typedef of a owning reference that uses an erased `Rc` as the owner.
pub type ErasedRcRef<'a, U> = OwningRef<'a, Rc<dyn Erased>, U>;
/// Typedef of a owning reference that uses an erased `Arc` as the owner.
pub type ErasedArcRef<'a, U> = OwningRef<'a, Arc<dyn Erased>, U>;

/// Typedef of a mutable owning reference that uses an erased `Box` as the owner.
pub type ErasedBoxRefMut<'a, U> = OwningRefMut<'a, Box<dyn Erased>, U>;
